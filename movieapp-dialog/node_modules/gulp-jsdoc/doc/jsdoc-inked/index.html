...
<h4 id="infos-plugins">infos.plugins</h4>
<p>Type: <code>Array</code><br>Default: <code>false</code></p>
<p>jsDoc plugins to use. Example: <code>[&#39;plugins/markdown&#39;]</code></p>
...
<p>Only the parser is really using streams. While the generator will read from the result of the parser, it will also read and write templates files synchronously on its own.</p>
...
<ul>
<li>tutorials</li>
<li>sourcing configuration from jsdoc.conf files</li>
</ul>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
		...
		on Mon Mar 31 2014 09:17:27 GMT+0200 (CEST) using the <a href="https://github.com/terryweiss/docstrap">DocStrap template</a>.
		</span>
				</footer>
			</div>
