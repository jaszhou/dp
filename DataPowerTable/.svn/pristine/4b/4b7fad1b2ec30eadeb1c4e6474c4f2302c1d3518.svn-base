...
<#macro page pageNumber text = "" attributes = "">
 <#setting url_escaping_charset='UTF-8'>
	...
	<a href="?${data.param}&amp;field=${data.sortField?url}&amp;page=${pageNumber?c}&amp;size=${data.pageSize}&amp;direction=${data.sortDirection?url}"${attributes}>${text?html}</a>
</#macro>
...
<#macro sort field text = "" attributes = "" directions = ["Asc", "Desc"]>
	...
	<a href="?${data.param}&amp;field=${field?url}&amp;page=${data.pageNumber?c}&amp;size=${data.pageSize}&amp;direction=${direction?url}"${attributes}>${text?html}</a>
</#macro>
