		...
		<form id="myForm" method="post" action="/saveuser">
			...
			<div class="form-group">
				<input type="text" class="form-control" placeholder="User Name"
					name="username" value="${user['_id']}" disable></input>
			</div>
			...
			<div class="form-group">
				<label for="role">Roles:</label> <br> <input type="checkbox"
					name="role1" value="Administrator" <#if x?seq_contains("Administrator")> checked </#if> > Administrator
